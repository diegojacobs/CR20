...
public class estadoGUI extends JDialog implements ActionListener {
	...
	public estadoGUI(JFrame frame){
		super(frame, "Estado", true);
		initialize();
	}
	
	public estadoGUI(JDialog frame){
		super(frame, "Estado", true);
		initialize();
	}
	
	public estadoGUI(JFrame frame, Estado estado){
		super(frame, "Estado", true);
		this.estado = estado;
		initialize();
		setValues(estado);
	...
	public estadoGUI(JDialog frame, Estado estado){
		super(frame, "Estado", true);
		this.estado = estado;
		initialize();
		setValues(estado);
	...
	public void setValues(Estado estado){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == guardar){
		   ...
		   if (estado != null){
			   ...
			   insertStatus = estado.updateEstados();
		   }else{
			   estado = new Estado(str_descripcion,connection.getCon());
			   insertStatus = estado.insertEstados();
		   }
		   ...
		   if (insertStatus != null)
				...
				JOptionPane.showMessageDialog(this, "Estado guardado exitosamente", "Estado", JOptionPane.PLAIN_MESSAGE);
				this.dispose();
		   }
